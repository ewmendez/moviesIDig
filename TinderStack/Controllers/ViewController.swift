...
class ViewController: UIViewController {
    ...
    //MARK: - Properties
    var viewModelData = [CardsDataModel(bgColor: UIColor(red:0.83, green:0.82, blue:0.69, alpha:1.0), text: "Pirates of the Caribbean", image: "pirates"),
                         CardsDataModel(bgColor: UIColor(red:0.83, green:0.82, blue:0.69, alpha:1.0), text: "She's The Man", image: "shestheman"),
                         CardsDataModel(bgColor: UIColor(red:0.83, green:0.82, blue:0.69, alpha:1.0), text: "Goonies", image: "goonies"),
